  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-4xl max-h-[85vh]">
        <DialogHeader>
          <DialogTitle className="text-2xl md:text-3xl font-bold">Terms & Conditions</DialogTitle>
          <DialogDescription className="mt-1 text-sm text-gray-500">
            Effective Date: October 1, 2025
          </DialogDescription>
        </DialogHeader>

        <div className="mt-4 space-y-6 max-h-[60vh] overflow-y-auto pr-4 text-gray-700 text-sm md:text-base leading-relaxed">
